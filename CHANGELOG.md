...
* [Added] Bump Datadog Agent Bosh Release to version 4.26.1. See [here](https://github.com/DataDog/datadog-agent-boshrelease/releases/tag/4.26.1) for details.
## 6.5.0 / 2026-03-17
...
* [Added] Bump Datadog Cluster Agent Bosh Release to version 2.15.1. See [here](https://github.com/DataDog/datadog-cluster-agent-boshrelease/releases/tag/2.15.1) for details.
...
* [Added] Bump Datadog Cluster Agent Bosh Release to version 2.12.0. See [here](https://github.com/DataDog/datadog-cluster-agent-boshrelease/releases/tag/2.12.0) for details.
