...
* [Added] Bump Datadog Cluster Agent Bosh Release to version 2.4.0. See [here](https://github.com/DataDog/datadog-cluster-agent-boshrelease/releases/tag/2.4.0) for details.
